---
title: Daily Intelligence 2026-07-14
date: 2026-07-14
tags:
  - daily-briefing
  - research-radar
...
> [!info]+ **今日必须看 / 79** | Sinity/polylogue
> **标题**：Sinity/polylogue
> **原文链接**：🔗 [打开原文](https://github.com/Sinity/polylogue)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：matches topics: agent, codex, mcp; high-value terms: agent, mcp, codex
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：A local evidence system for AI work—unifying ChatGPT, Claude, Codex, Gemini, and agent histories into one searchable, auditable archive.
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> [!info]+ **可延后 / 72** | lthoangg/OpenAgentd
> **标题**：lthoangg/OpenAgentd
> **原文链接**：🔗 [打开原文](https://github.com/lthoangg/OpenAgentd)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：matches topics: agent, agents, llm; high-value terms: agent, agents
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：Self-hosted AI agent OS — streaming chat, tool use, persistent memory, and multi-agent teams. Runs entirely on your machine.
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> [!info]+ **可延后 / 72** | Hogu59/claude-news
> **标题**：Hogu59/claude-news
> **原文链接**：🔗 [打开原文](https://github.com/Hogu59/claude-news)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：matches topics: claude code, anthropic, mcp; high-value terms: mcp, claude code
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：Daily AI-curated briefing for Claude Code & Anthropic ecosystem (KO/EN/JA)
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> [!info]+ **可延后 / 72** | soenneker/soenneker.maf.pool.anthropic
> **标题**：soenneker/soenneker.maf.pool.anthropic
> **原文链接**：🔗 [打开原文](https://github.com/soenneker/soenneker.maf.pool.anthropic)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：matches topics: agent, agents, anthropic; high-value terms: agent, agents
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：Provides Anthropic-specific registration extensions for MafPoolManager, enabling integration via Microsoft Agent Framework.
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> [!info]+ **可延后 / 64** | TMYTiMidlY/portal-mcp-server
> **标题**：TMYTiMidlY/portal-mcp-server
> **原文链接**：🔗 [打开原文](https://github.com/TMYTiMidlY/portal-mcp-server)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：matches topics: agent, mcp; high-value terms: agent, mcp
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：Agent-first SSH orchestration MCP server: persistent bash sessions, hash-protected remote file editing, SFTP, SSH tunnels, and multi-host orchestration. Built on AsyncSSH + FastMCP with an in-process connection pool shared across every tool. Windows / macOS / Linux.
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> [!info]+ **可延后 / 64** | soenneker/soenneker.maf.dtos.options
> **标题**：soenneker/soenneker.maf.dtos.options
> **原文链接**：🔗 [打开原文](https://github.com/soenneker/soenneker.maf.dtos.options)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：matches topics: agent, agents; high-value terms: agent, agents
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：Options for creating a Microsoft Agent Framework Agent instance.
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> [!info]+ **可延后 / 64** | deer-flow/llm-space
> **标题**：deer-flow/llm-space
> **原文链接**：🔗 [打开原文](https://github.com/deer-flow/llm-space)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：matches topics: agent, llm; high-value terms: agent, eval
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：A desktop app to prototype agent ideas, inspect every harness step, replay failures, and evaluate performance, all in one place. Local-first.
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> [!info]+ **可延后 / 64** | Blackcat-Informatics/gmeow-ontology
> **标题**：Blackcat-Informatics/gmeow-ontology
> **原文链接**：🔗 [打开原文](https://github.com/Blackcat-Informatics/gmeow-ontology)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：matches topics: llm, mcp; high-value terms: mcp, reasoning
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：Ground LLM output as provenance-tracked claims, not truths. A maximal super-ontology + native RDF-1.2 logic: reasoning engine — OWL, SHACL, SSSOM, EDOAL are generated lossy projections; a correspondence calculus losslessly subsumes external vocabularies. Rust-first (pip / MCP /...
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> [!info]+ **可延后 / 64** | inference-gateway/adl-cli
> **标题**：inference-gateway/adl-cli
> **原文链接**：🔗 [打开原文](https://github.com/inference-gateway/adl-cli)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：matches topics: agent, agents; high-value terms: agent, agents
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：A command-line tool to scaffold and manage enterprise-ready AI Agents powered by the A2A (Agent-to-Agent) protocol
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> [!info]+ **可延后 / 57** | SauravP97/ai-engineering-primer
> **标题**：SauravP97/ai-engineering-primer
> **原文链接**：🔗 [打开原文](https://github.com/SauravP97/ai-engineering-primer)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：matches topics: agent, llm; high-value terms: agent
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：Learn Agentic AI, Deep Learning, Agentic Engineering, RAG and Multi-Agent Workflows.
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> [!info]+ **可延后 / 56** | Choihello/startup-law-mcp
> **标题**：Choihello/startup-law-mcp
> **原文链接**：🔗 [打开原文](https://github.com/Choihello/startup-law-mcp)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：matches topics: mcp; high-value terms: mcp, api
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：창업 관련 한국 법령 50개 문서·8,191개 조문을 조문 단위로 검색·조회·검증하는 MCP 서버 (국가법령정보센터 Open API 자동 동기화)
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> [!info]+ **可延后 / 50** | netresearch/t3x-nr-llm
> **标题**：netresearch/t3x-nr-llm
> **原文链接**：🔗 [打开原文](https://github.com/netresearch/t3x-nr-llm)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：matches topics: llm, research
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：The shared AI foundation for TYPO3 — one LLM setup for every extension on your site
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> [!info]+ **只归档 / 49** | jmagar/soma
> **标题**：jmagar/soma
> **原文链接**：🔗 [打开原文](https://github.com/jmagar/soma)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：matches topics: mcp; high-value terms: mcp
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：Batteries-included RMCP runtime and scaffold for shipping Rust MCP servers with CLI/REST/HTTP MCP, auth, providers, plugins, and generated contracts.
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> [!info]+ **只归档 / 49** | burnban/burnban
> **标题**：burnban/burnban
> **原文链接**：🔗 [打开原文](https://github.com/burnban/burnban)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：matches topics: agent; high-value terms: agent
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：burnban — local meter & cap for AI-agent spend (MIT). Meters watch. Burnban acts.
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> **reason**：strong public engagement
> **follow_up**：阅读讨论区，提炼争议点和实践经验。
> **summary**：377 points | 381 comments
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> [!info]+ **只归档 / 42** | dstrunin/fed-chirp
> **标题**：dstrunin/fed-chirp
> **原文链接**：🔗 [打开原文](https://github.com/dstrunin/fed-chirp)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：matches topics: llm
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：Personal monitor of Federal Reserve communications: scrapes Board governor speeches and FOMC docs, scores hawk/dove tone via Claude, alerts on tone shifts.
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> [!info]+ **只归档 / 42** | microsoft/SwiftStreamingMarkdown
> **标题**：microsoft/SwiftStreamingMarkdown
> **原文链接**：🔗 [打开原文](https://github.com/microsoft/SwiftStreamingMarkdown)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：matches topics: llm
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：A performant markdown library for iOS & macOS that supports streaming
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> **source**：Hacker News
> **kind**：`community`
> **reason**：HN engagement: 83 points, 32 comments
> **follow_up**：阅读讨论区，提炼争议点和实践经验。
> **summary**：83 points | 32 comments
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> [!info]+ **只归档 / 34** | amosproj/amos2026ss03-ailixir-intelligence
> **标题**：amosproj/amos2026ss03-ailixir-intelligence
> **原文链接**：🔗 [打开原文](https://github.com/amosproj/amos2026ss03-ailixir-intelligence)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：6 stars | pushed 2026-07-15
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：RAG-powered data context platform. Chat with complex technical documents and build knowledge bases.
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> [!info]+ **只归档 / 34** | 0mao0/AnGIneer
> **标题**：0mao0/AnGIneer
> **原文链接**：🔗 [打开原文](https://github.com/0mao0/AnGIneer)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：3 stars | pushed 2026-07-15
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：SLM + SOPs + EngTools + GeoWorld = AI Engineer
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> [!info]+ **只归档 / 34** | Teecash96/DeltaZero
> **标题**：Teecash96/DeltaZero
> **原文链接**：🔗 [打开原文](https://github.com/Teecash96/DeltaZero)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：0 stars | pushed 2026-07-15
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：Autonomous DeFi risk management platform for building, auditing and stress testing pseudo delta neutral strategies as OKX ASP
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
