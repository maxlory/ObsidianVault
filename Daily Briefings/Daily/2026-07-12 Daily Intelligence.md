---
title: Daily Intelligence 2026-07-12
date: 2026-07-12
tags:
  - daily-briefing
  - research-radar
...
> [!info]+ **今日必须看 / 79** | Moeabdelaziz007/AxiomID
> **标题**：Moeabdelaziz007/AxiomID
> **原文链接**：🔗 [打开原文](https://github.com/Moeabdelaziz007/AxiomID)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：matches topics: agent, agents, mcp; high-value terms: agent, agents, mcp
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：Axiom Identity Protocol (AIP) — Universal, vendor-neutral identity layer for Humans + AI Agents + Autonomous Systems. Identity, Passport, DID, Pi Network, Sovereign Edge.
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> [!info]+ **可延后 / 72** | baiyuheniao/BaiyuAISpace2
> **标题**：baiyuheniao/BaiyuAISpace2
> **原文链接**：🔗 [打开原文](https://github.com/baiyuheniao/BaiyuAISpace2)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：matches topics: agent, llm, mcp; high-value terms: agent, mcp
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：轻量级跨平台 LLM 客户端 + AI Agent 开发环境 | Lightweight cross-platform LLM client & agent workspace (Tauri 2 + Vue 3 + Rust)
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> [!info]+ **可延后 / 72** | edgarfloresguerra2011-a11y/marketnow
> **标题**：edgarfloresguerra2011-a11y/marketnow
> **原文链接**：🔗 [打开原文](https://github.com/edgarfloresguerra2011-a11y/marketnow)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：matches topics: agent, llm, mcp; high-value terms: agent, mcp
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：Trust layer for agent commerce. 8,764 MCP servers, Sentinel L2.5 gVisor sandbox audits, AP2 mandates, x402 payments. AliceLabs LLC Proprietary.
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> [!info]+ **可延后 / 57** | hectormr206/lifeos
> **标题**：hectormr206/lifeos
> **原文链接**：🔗 [打开原文](https://github.com/hectormr206/lifeos)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：matches topics: llm, mcp; high-value terms: mcp
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：LifeOS / Axi — local-first AI personal assistant. Voice + vision + memory + real-time EN→ES interpreter, running 100% on a single laptop with Qwen on GPU.
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> [!info]+ **只归档 / 49** | KotaHusky/cicd-toolkit
> **标题**：KotaHusky/cicd-toolkit
> **原文链接**：🔗 [打开原文](https://github.com/KotaHusky/cicd-toolkit)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：matches topics: claude code; high-value terms: claude code
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：Reusable GitHub Actions workflows, composite actions, and AWS CDK constructs for CI/CD — plus a Claude Code plugin marketplace for AI-assisted integration.
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> [!info]+ **只归档 / 49** | SamuckqaDev/avento-ia
> **标题**：SamuckqaDev/avento-ia
> **原文链接**：🔗 [打开原文](https://github.com/SamuckqaDev/avento-ia)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：matches topics: mcp; high-value terms: mcp
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：Assistente local-first com Ollama, MCP, automação de projetos, voz e geração de mídia.
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> [!info]+ **只归档 / 49** | ghdtjdwn/ssuMCP
> **标题**：ghdtjdwn/ssuMCP
> **原文链接**：🔗 [打开原文](https://github.com/ghdtjdwn/ssuMCP)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：matches topics: mcp; high-value terms: mcp
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：숭실대학교 MCP 서버 - 학식, 도서관, 시설, u-SAINT, LMS 정보를 MCP 클라이언트에서 사용
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> [!info]+ **只归档 / 49** | Notryag/dayboard
> **标题**：Notryag/dayboard
> **原文链接**：🔗 [打开原文](https://github.com/Notryag/dayboard)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：matches topics: llm; high-value terms: api
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：中文 AI 日程与待办助手：用自然语言或语音创建、查询和调整日程，支持 Next.js、FastAPI、PostgreSQL 与 Docker Compose。
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> [!info]+ **只归档 / 49** | Kirky-X/CodeNexus
> **标题**：Kirky-X/CodeNexus
> **原文链接**：🔗 [打开原文](https://github.com/Kirky-X/CodeNexus)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：matches topics: mcp; high-value terms: mcp
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：Multi-language code knowledge graph built on LadybugDB and tree-sitter — semantic code search, symbol tracing, impact analysis, data-flow analysis, and MCP server integration
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> **reason**：strong public engagement
> **follow_up**：阅读讨论区，提炼争议点和实践经验。
> **summary**：377 points | 380 comments
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> [!info]+ **只归档 / 42** | beam-cloud/beta9
> **标题**：beam-cloud/beta9
> **原文链接**：🔗 [打开原文](https://github.com/beam-cloud/beta9)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：matches topics: llm
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：Ultrafast serverless GPU inference, sandboxes, and background jobs
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：54 stars | pushed 2026-07-15
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
...
> [!info]+ **只归档 / 34** | magefree/mage
> **标题**：magefree/mage
> **原文链接**：🔗 [打开原文](https://github.com/magefree/mage)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：strong public engagement
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：XMage - Magic Another Game Engine
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> [!info]+ **只归档 / 34** | ysichov/Smart-Debugger
> **标题**：ysichov/Smart-Debugger
> **原文链接**：🔗 [打开原文](https://github.com/ysichov/Smart-Debugger)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：63 stars | pushed 2026-07-15
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：Simple Debugger - Data Explorer - debugger time machine which store every variables changes on every steps and show it in convenient format. Usuful to analyse deep structures, several tables simultaneously and search changes in the past!
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
...
> [!info]+ **只归档 / 34** | rezapranata089-bit/FRTool
> **标题**：rezapranata089-bit/FRTool
> **原文链接**：🔗 [打开原文](https://github.com/rezapranata089-bit/FRTool)
> **source**：GitHub Search
> **kind**：`github_repo`
> **reason**：1 stars | pushed 2026-07-15
> **follow_up**：查看 README、最近 release 和 issue，判断是否加入工具评估清单。
> **summary**：Smart AI Find & Replace Tool for Termux
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
