...
> [!info]+ **今日必须看 / 86** | Google DeepMind 发布 Nano Banana 2 Lite 和 Gemini Omni Flash
...
### matches topics: agent; high-value terms: agent, reasoning

> [!info]+ **今日必须看 / 93** | 美团 LongCat 发布旗舰模型 LongCat-2.0
> **标题**：美团 LongCat 发布旗舰模型 LongCat-2.0
> **原文链接**：🔗 [打开原文](https://x.com/SiliconFlowAI/status/2071831773076746715)
...
### matches topics: codex, mcp; high-value terms: mcp, codex, api

> [!info]+ **今日必须看 / 100** | X（Twitter）发布 hosted X MCP，AI 智能体可直连 X API
> **标题**：X（Twitter）发布 hosted X MCP，AI 智能体可直连 X API
> **原文链接**：🔗 [打开原文](https://x.com/op7418/status/2071816099986022650)
> **source**：AI HOT Daily / X：歸藏 (@op7418)
> **kind**：`product`
> **reason**：matches topics: codex, mcp; high-value terms: mcp, codex, api
...
> [!info]+ **今日必须看 / 81** | 用 shot-scraper video 让 AI 智能体录制工作演示视频
...
> [!info]+ **今日必须看 / 81** | ADK Go 2.0 发布：构建可靠的多智能体应用，新增基于图的工作流引擎、人工参与循环与动态编排
...
> [!info]+ **可延后 / 66** | Acti 将 AI 智能体直接放入手机键盘
...
> [!info]+ **今日必须看 / 89** | AI News Radar 大更新：新增自媒体板块，支持订阅多平台账号
> **标题**：AI News Radar 大更新：新增自媒体板块，支持订阅多平台账号
> **原文链接**：🔗 [打开原文](https://mp.weixin.qq.com/s/iW5FVqbHtYi31mJ22Q_cog)
...
> [!info]+ **今日必须看 / 81** | Claude Desktop 推出 Linux 公测版
...
> [!info]+ **今日必须看 / 89** | Claude Science 科研工作台正式上线
...
> [!info]+ **可延后 / 64** | 特斯拉Cybercab量产版在奥斯汀启动公开道路工程测试
> **标题**：特斯拉Cybercab量产版在奥斯汀启动公开道路工程测试
> **原文链接**：🔗 [打开原文](https://www.ithome.com/0/970/539.htm)
...
> [!info]+ **可延后 / 64** | 商务部解除Claude Fable 5等出口管制
> **标题**：商务部解除Claude Fable 5等出口管制
> **原文链接**：🔗 [打开原文](https://x.com/AnthropicAI/status/2072106151890809341)
...
> [!info]+ **可延后 / 72** | Meta秘密测试ChatGPT等竞品：承包商假扮未成年发送数万条危机提示
...
> [!info]+ **今日必须看 / 76** | OpenAI 发布 GeneBench-Pro：计算生物学研究级基准测试
> **标题**：OpenAI 发布 GeneBench-Pro：计算生物学研究级基准测试
...
> [!info]+ **可延后 / 72** | OpenAI Signals 数据揭示 ChatGPT 全球采用趋势
> **标题**：OpenAI Signals 数据揭示 ChatGPT 全球采用趋势
> **原文链接**：🔗 [打开原文](https://openai.com/index/how-chatgpt-adoption-has-expanded)
> **source**：AI HOT Daily / OpenAI：官网动态（RSS · 排除企业/客户案例）
> **kind**：`article`
> **reason**：matches topics: openai
> **follow_up**：判断是否需要沉淀为长期主题笔记。
...
> [!info]+ **今日必须看 / 80** | 黑石未来3～5年拟投300亿美元在日本建AI数据中心，联合成立AI XPV平台
> **标题**：黑石未来3～5年拟投300亿美元在日本建AI数据中心，联合成立AI XPV平台
> **原文链接**：🔗 [打开原文](https://www.ithome.com/0/970/583.htm)
> **source**：AI HOT Daily / IT之家（RSS）
> **kind**：`article`
...
> [!info]+ **今日必须看 / 76** | AI 用 prover-verifier LLM 循环攻克 9 个未解数学难题
> **标题**：AI 用 prover-verifier LLM 循环攻克 9 个未解数学难题
> **原文链接**：🔗 [打开原文](https://x.com/AISafetyMemes/status/2072085914558558402)
> **source**：AI HOT Daily / X：AI Safety Memes (@AISafetyMemes)
> **kind**：`paper`
...
> [!info]+ **今日必须看 / 76** | Anthropic 提出回合平均稀疏自编码器 (Turn-Averaged SAE)
> **标题**：Anthropic 提出回合平均稀疏自编码器 (Turn-Averaged SAE)
> **原文链接**：🔗 [打开原文](https://transformer-circuits.pub/2026/june-update/index.html)
...
> [!info]+ **今日必须看 / 94** | 一个人管理5款产品，80%时间不写代码？Every的复利工程
> **标题**：一个人管理5款产品，80%时间不写代码？Every的复利工程
> **原文链接**：🔗 [打开原文](https://x.com/xiaohu/status/2071796715162857477)
...
> [!info]+ **今日必须看 / 94** | Claude Code 入门：智能体循环
...
> [!info]+ **可延后 / 64** | AI就业争论变得更加混乱
> **标题**：AI就业争论变得更加混乱
> **原文链接**：🔗 [打开原文](https://techcrunch.com/2026/06/29/the-ai-jobs-debate-just-got-messier)
> **source**：AI HOT Daily / TechCrunch：AI（RSS）
> **kind**：`article`
...
> [!info]+ **可延后 / 64** | 具身智能数据采集员：日薪200元起，给机器人当老师
> **标题**：具身智能数据采集员：日薪200元起，给机器人当老师
> **原文链接**：🔗 [打开原文](https://mp.weixin.qq.com/s/aSd4kLu7xHllZatrd5EGsw)
...
> [!info]+ **可延后 / 64** | Grant Sanderson 谈 AI 与数学的未来
...
> [!info]+ **可延后 / 64** | 英国职场AI采用率翻倍，仅15%“AI先锋”获得晋升加薪优势
> **标题**：英国职场AI采用率翻倍，仅15%“AI先锋”获得晋升加薪优势
> **原文链接**：🔗 [打开原文](https://blog.google/company-news/inside-google/around-the-globe/google-europe/united-kingdom/unlocking-britains-next-era-of-productivity-building-a-nation-of-ai-trailblazers)
...
> [!info]+ **可延后 / 64** | 专业化为何不可避免
> **标题**：专业化为何不可避免
> **原文链接**：🔗 [打开原文](https://huggingface.co/blog/Dharma-AI/why-specialization-is-inevitable)
