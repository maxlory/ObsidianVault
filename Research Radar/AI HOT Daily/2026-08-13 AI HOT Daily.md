...
# 2026-08-13 AI HOT Daily

## AI HOT 官方日报

### 模型发布/更新

> [!info]+ **可延后 / 71** | xAI 发布 Grok 4.6，强化长时运行智能体能力
> **标题**：xAI 发布 Grok 4.6，强化长时运行智能体能力
> **原文链接**：🔗 [打开原文](https://x.ai/news/grok-4-6)
...
> [!info]+ **可延后 / 71** | 阿里开放 Qwen3.8-2.4T-A95B 模型权重：2.4T MoE、激活 95B、原生 256K 上下文
...
> [!info]+ **可延后 / 71** | LTX-2.5 模型登场：AI 生成 10 秒 720P 视频仅需 6.8 秒，原生集成 ComfyUI
...
> [!info]+ **可延后 / 71** | 微软首发自研推理模型MAI-Thinking-1
> **标题**：微软首发自研推理模型MAI-Thinking-1
> **原文链接**：🔗 [打开原文](https://x.com/mustafasuleyman/status/2087570047967408396)
> **source**：AI HOT Daily / X：Mustafa Suleyman（Microsoft AI CEO） (@mustafasuleyman)
> **kind**：`model`
> **reason**：AI HOT official daily section: 模型发布/更新
> **follow_up**：检查模型卡、license、benchmark 和可部署性。
...
> [!info]+ **可延后 / 66** | OpenRouter 推出实时网页搜索基准测试：如何为智能体选择引擎、深度与模型
> **标题**：OpenRouter 推出实时网页搜索基准测试：如何为智能体选择引擎、深度与模型
> **原文链接**：🔗 [打开原文](https://openrouter.ai/blog/announcements/web-search-benchmark)
...
> [!info]+ **可延后 / 66** | Claude in Chrome 侧边栏升级为 Claude Cowork 会话
...
> [!info]+ **可延后 / 66** | SGLang 与 Miles 为 Qwen3.8-2.4T-A95B 提供 Day-0 支持
> **标题**：SGLang 与 Miles 为 Qwen3.8-2.4T-A95B 提供 Day-0 支持
> **原文链接**：🔗 [打开原文](https://www.lmsys.org/blog/2026-08-12-qwen3-8-day0-support)
...
> [!info]+ **可延后 / 66** | WhatsApp 如何用端到端加密与可验证性构建 Scam Alert 诈骗提醒功能
> **标题**：WhatsApp 如何用端到端加密与可验证性构建 Scam Alert 诈骗提醒功能
> **原文链接**：🔗 [打开原文](https://engineering.fb.com/2026/08/12/security/how-were-building-scam-alert-whatsapp)
...
> [!info]+ **今日必须看 / 81** | Claude Code v2.1.229 发布：新增远程会话恢复、插件市场命令源及多项修复
> **标题**：Claude Code v2.1.229 发布：新增远程会话恢复、插件市场命令源及多项修复
> **原文链接**：🔗 [打开原文](https://github.com/anthropics/claude-code/releases/tag/v2.1.229)
...
> [!info]+ **可延后 / 72** | Research Gold 号称“100%人类撰写、绝不使用AI”，实则全程由AI驱动
...
> [!info]+ **今日必须看 / 79** | RingCentral 如何用 ChatGPT Work 和 Codex 构建 AI 原生工作流
> **标题**：RingCentral 如何用 ChatGPT Work 和 Codex 构建 AI 原生工作流
> **原文链接**：🔗 [打开原文](https://openai.com/index/ringcentral)
...
> [!info]+ **今日必须看 / 79** | 零基础用户半天上手AI的12步实操流程
> **标题**：零基础用户半天上手AI的12步实操流程
> **原文链接**：🔗 [打开原文](https://mp.weixin.qq.com/s?__biz=MzIyMzA5NjEyMA%3D%3D&mid=2647685084&idx=1&sn=0899296dbc140eeb745f7a99f9d5ed9c)
...
> [!info]+ **今日必须看 / 84** | 空货架还是丢钥匙？Google 研究：Recall 是参数化事实性的瓶颈
...
> [!info]+ **今日必须看 / 76** | Anthropic 联合独立研究者发布工人再培训项目证据综述
> **标题**：Anthropic 联合独立研究者发布工人再培训项目证据综述
...
> [!info]+ **可延后 / 64** | DeepSeek V4 Pro与Grok 4.6同日发布，双双逼近Claude Fable 5体验
...
> [!info]+ **可延后 / 64** | LangChain 详解：什么是 AI 智能体？
> **标题**：LangChain 详解：什么是 AI 智能体？
> **原文链接**：🔗 [打开原文](https://www.langchain.com/blog/what-is-an-agent)
...
> [!info]+ **今日必须看 / 94** | AutoGPT 如何用 AGENTS.md 和技能门控管理 AI 生成的拉取请求
...
> [!info]+ **可延后 / 72** | 我写了一本 AI 教科书——AI 还要多久才能写得更好？
...
> [!info]+ **可延后 / 72** | OpenRouter 工具调用指南：一次编写循环，切换模型字符串即可跨模型运行
> **标题**：OpenRouter 工具调用指南：一次编写循环，切换模型字符串即可跨模型运行
> **原文链接**：🔗 [打开原文](https://openrouter.ai/blog/tutorials/tool-calling)
> **source**：AI HOT Daily / OpenRouter：Announcements（RSS）
> **kind**：`article`
...
> [!info]+ **今日必须看 / 87** | OpenAI 研究：企业如何用 ChatGPT 和 Codex 落地智能体 AI
> **标题**：OpenAI 研究：企业如何用 ChatGPT 和 Codex 落地智能体 AI
> **原文链接**：🔗 [打开原文](https://openai.com/index/how-enterprises-put-ai-to-work)
> **source**：AI HOT Daily / OpenAI：官网动态（RSS · 排除企业/客户案例）
> **kind**：`article`
