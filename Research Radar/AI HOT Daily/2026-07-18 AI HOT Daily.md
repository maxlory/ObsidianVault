...
# 2026-07-18 AI HOT Daily

## AI HOT 官方日报

### 模型发布/更新

> [!info]+ **可延后 / 71** | Sora 2 视频克隆效果惊人，真假难辨
> **标题**：Sora 2 视频克隆效果惊人，真假难辨
> **原文链接**：🔗 [打开原文](https://x.com/gabriel1/status/2078156277247881438)
> **source**：AI HOT Daily / X：Gabriel (@gabriel1)
> **kind**：`model`
...
> [!info]+ **可延后 / 71** | NVIDIA 发布 Nemotron 3 Embed 系列，8B 版本在 RTEB 基准上排名第一
...
> [!info]+ **可延后 / 71** | 通义实验室发布 Wan-Streamer v0.2，端到端响应延迟仅 550ms
...
> [!info]+ **今日必须看 / 78** | Kimi K3 登顶前端编码榜，开放权重挑战闭源双巨头
...
> [!info]+ **今日必须看 / 75** | Apple 研究：Show Me Examples — 从图像集推断视觉概念
> **标题**：Apple 研究：Show Me Examples — 从图像集推断视觉概念
> **原文链接**：🔗 [打开原文](https://machinelearning.apple.com/research/visual-concept-inference)
...
> [!info]+ **今日必须看 / 96** | Claude Code v2.1.212 发布
> **标题**：Claude Code v2.1.212 发布
> **原文链接**：🔗 [打开原文](https://github.com/anthropics/claude-code/releases/tag/v2.1.212)
...
> [!info]+ **可延后 / 72** | Apple 起诉 OpenAI：诉讼背后是竞争焦虑还是时机博弈？
...
> [!info]+ **可延后 / 72** | 苹果与 OpenAI 法律战升级：约 40 名前员工收到苹果律师函
...
> [!info]+ **可延后 / 72** | OpenAI 提出 AI 时代记分卡：“有用智能每美元”衡量实际工作价值
...
> [!info]+ **今日必须看 / 83** | 月之暗面在GTC 2026披露Kimi K2.5技术路线：用MuonClip、线性注意力与Agent Swarm重构三大基础组件
...
> [!info]+ **今日必须看 / 79** | 首届“小有可为”大赛乡村教育一等奖作品“智绘科普”技术拆解
...
> [!info]+ **可延后 / 68** | Schema Harness 在 ARC-AGI-3 公开集上取得约 99% 成绩
...
> [!info]+ **可延后 / 68** | 美团LongCat发布LoHoSearch：更难搜索智能体基准
...
> [!info]+ **可延后 / 64** | 八天四款前沿模型发布，Kimi K3 跻身第三
...
> [!info]+ **可延后 / 64** | 生成式人工智能是一场工程灾难：AI公司抢购70%高端内存，推高电脑价格
> **标题**：生成式人工智能是一场工程灾难：AI公司抢购70%高端内存，推高电脑价格
> **原文链接**：🔗 [打开原文](https://www.theatlantic.com/technology/2026/07/generative-ai-engineering-disaster/687901)
> **source**：AI HOT Daily / Hacker News 热门（buzzing.cc 中文翻译）
> **kind**：`article`
> **reason**：AI HOT official daily section: 技巧与观点
> **follow_up**：判断是否需要沉淀为长期主题笔记。
...
> [!info]+ **可延后 / 64** | Cursor 评估负责人确认 Claude Fable 5 在 CursorBench 达 72.9% 新高
...
> [!info]+ **可延后 / 64** | AI 时代“小需求”的成本逻辑变了：GitHub 博客谈工程决策新范式
> **标题**：AI 时代“小需求”的成本逻辑变了：GitHub 博客谈工程决策新范式
> **原文链接**：🔗 [打开原文](https://github.blog/engineering/the-cost-of-saying-yes-has-changed)
...
> [!info]+ **可延后 / 72** | Anthropic 副首席信息安全官发布智能体 AI 风险评估框架：零风险不是目标
> **标题**：Anthropic 副首席信息安全官发布智能体 AI 风险评估框架：零风险不是目标
> **原文链接**：🔗 [打开原文](https://claude.com/blog/ciso-guide-to-agentic-ai)
> **source**：AI HOT Daily / Claude：Blog（网页）
> **kind**：`article`
> **reason**：matches topics: anthropic
> **follow_up**：判断是否需要沉淀为长期主题笔记。
> **summary**：Anthropic 副首席信息安全官 Jason Clinton 分享了其团队在采用智能体 AI 过程中的经验教训，并提出了一套用于安全构建和部署智能体的风险评估框架。该框架通过四个核心问题（摄入的不可信内容、可执行的操作、失控时的爆炸半径、可观测性）来评估风险，并强调“最小代理权限”原则。Anthropic 的默认策略是管理员控制的分阶段推出，并指出与意图偏离的智能体在行为上无异于内部攻击。
>
> **人工选择**：
> - [ ] 纳入长期知识库
> - [ ] 稍后复盘
